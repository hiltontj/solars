...
const DateSelector = () => {
  ...
  return (
    <div className="date-container">
      <label className="item-y-label" htmlFor="d-sel-year">Year</label>
      <input
        id="d-sel-year"
      ...
      />
      <label className="item-m-label" htmlFor="d-sel-month">Month</label>
      <input
        id="d-sel-month"
        ...
        onScroll={(e) => console.debug(e)}
      />
      <label className="item-d-label" htmlFor="d-sel-day">Day</label>
      <input
        id="d-sel-day"
